((cssText, artDataUrl, rawConfig, version) => {
  ...
  window[STATE_KEY] = {
    ensure, cleanup, observer, timer, scheduler, artUrl, profile, config, installToken, version,
  };
  ensure();
  ...
  return { installed: true, version, adaptive: true };
